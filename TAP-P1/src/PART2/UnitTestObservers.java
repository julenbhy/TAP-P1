...
public class UnitTestObservers {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		TimeUnit.SECONDS.sleep(1);
		albigle.sendMail("AlbertoChicote", "Problemas en la cocina", "Buenos dias Alberto, actualmente llevo un restaurante que no esta funcionando muy bien podr�as ayudarme a sacarlo adelante, sino me arruinare en menos de un mes. AYUDA");
		TimeUnit.SECONDS.sleep(1);
